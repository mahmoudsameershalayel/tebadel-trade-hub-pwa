...
const translations = {
  en: {
    ...
    "app.description":
      "Trade items without money on Tebadel - the modern barter system",
    ...
    "forgotPassword.phoneRequired": "Phone number is required",
    "forgotPassword.codeSent": "Verification code sent successfully!",
    "forgotPassword.sendError": "Failed to send verification code",
    "forgotPassword.sendCode": "Send Verification Code",
    "forgotPassword.backToLogin": "Back to Login",

    // Verify Code
    "verifyCode.title": "Verify Your Phone",
    "verifyCode.subtitle": "Enter the verification code sent to {phone}",
    "verifyCode.codeLabel": "Verification Code",
    "verifyCode.codeRequired": "Verification code is required",
    "verifyCode.codeVerified": "Code verified successfully!",
    "verifyCode.verifyError": "Invalid verification code",
    "verifyCode.verifyButton": "Verify Code",
    "verifyCode.resendCode": "Resend Code",
    "verifyCode.codeResent": "Verification code resent successfully!",
    "verifyCode.resendError": "Failed to resend verification code",
    "verifyCode.backToPhone": "Back to Phone Number",
    ...
    "resetPassword.confirmPlaceholder": "Confirm new password",
    ...
    "resetPassword.resetSuccess": "Password reset successfully!",
    "resetPassword.resetError": "Failed to reset password",
    ...
    "landing.heroSubtitle":
      "The modern barter platform: trade what you don not need for what you want — with the option to add or receive a money difference.",
    "landing.getStarted": "Get Started Free",
    "landing.signIn": "Sign In",
    "landing.message":
      "With Tebadel, money is optional — only when you need it.",

    // Features
    "landing.featuresTitle": "Why Choose Tebadel?",
    "landing.featuresSubtitle":
      "Experience the easiest and safest way to trade items — with optional cash difference when needed.",
    "landing.feature1.title": "Trade Anything",
    "landing.feature1.description":
      "Exchange items without direct selling — and add or receive a money difference if necessary.",
    "landing.feature2.title": "Safe Community",
    "landing.feature2.description":
      "Join a trusted community of traders with verified profiles and ratings.",
    "landing.feature3.title": "Secure Trading",
    "landing.feature3.description":
      "Protected transactions with built-in dispute resolution and support.",
    "landing.feature4.title": "Instant Matching",
    "landing.feature4.description":
      "Smart algorithm matches you with traders who want what you have.",

    // Services
    "landing.servicesTitle": "Our Services",
    "landing.servicesSubtitle":
      "Comprehensive trading solutions tailored for the modern Arabic marketplace",
    "landing.services.direct.title": "Direct Item Exchange",
    "landing.services.direct.description":
      "Trade items directly without any money involved. Perfect for equal value exchanges.",
    "landing.services.money.title": "Money Difference Trading",
    "landing.services.money.description":
      "Add or receive money to balance the trade when items have different values.",
    "landing.services.secure.title": "Secure Transactions",
    "landing.services.secure.description":
      "All trades are protected with our secure escrow system and dispute resolution.",
    "landing.services.community.title": "Community Verification",
    "landing.services.community.description":
      "User verification system ensures safe trading with trusted community members.",
    ...
    "landing.testimonials.user1.text":
      "Tebadel made it so easy to trade my old laptop for a bicycle. The money difference feature was perfect!",
    "landing.testimonials.user2.name": "Fatima Hassan",
    "landing.testimonials.user2.text":
      "I love how safe and secure the platform is. Trading has never been this convenient.",
    "landing.testimonials.user3.name": "Omar Mahmoud",
    "landing.testimonials.user3.text":
      "The community is amazing and the customer support is excellent. Highly recommended!",

    // FAQ
    "landing.faqTitle": "Frequently Asked Questions",
    "landing.faqSubtitle":
      "Everything you need to know about trading on Tebadel",
    "landing.faq.q1.question": "How does the money difference feature work?",
    "landing.faq.q1.answer":
      "When trading items of different values, you can add or receive money to balance the trade. This makes fair exchanges possible for any items.",
    "landing.faq.q2.question": "Is my personal information safe?",
    "landing.faq.q2.answer":
      "Yes, we use advanced encryption and security measures to protect all user data. Your privacy is our top priority.",
    "landing.faq.q3.question": "What if I have a dispute with another trader?",
    "landing.faq.q3.answer":
      "We have a comprehensive dispute resolution system with dedicated support staff to help resolve any issues fairly.",
    "landing.faq.q4.question": "Are there any fees for using Tebadel?",
    "landing.faq.q4.answer":
      "Basic trading is free! We only charge a small fee for premium features and secure payment processing.",
    ...
    "trade.descriptionPlaceholder":
      "Enter a description for your offer (optional)",
    ...
    noAddressesDescription:
      "Add your first address to get started with deliveries and exchanges.",
    addFirstAddress: "Add Your First Address",
    addressDetails: "Address Details",
    addressName: "Address Name",
    addressNamePlaceholder: "Enter address name",
    ...
    defaultAddressDescription:
      "Use this as your primary address for deliveries",
    default: "Default",
    ...
    famousSign: "Famous Sign",
    famousSignPlaceholder: "Enter famous landmark or sign",
    building: "Building",
    floor: "Floor",
    flat: "Flat",
    notes: "Notes",
    ...
    "exchange.status.cancelled": "Cncelled",
    "exchange.status.pendingDelivery": "PendingDelivery",
  ...
  ar: {
    ...
    "forgotPassword.subtitle": "أدخل رقم هاتفك لتلقي رمز التحقق",
    "forgotPassword.phoneRequired": "رقم الهاتف مطلوب",
    "forgotPassword.codeSent": "تم إرسال رمز التحقق بنجاح!",
    "forgotPassword.sendError": "فشل في إرسال رمز التحقق",
    "forgotPassword.sendCode": "إرسال رمز التحقق",
    "forgotPassword.backToLogin": "العودة إلى تسجيل الدخول",

    // Verify Code
    "verifyCode.title": "تحقق من هاتفك",
    "verifyCode.subtitle": "أدخل رمز التحقق المرسل إلى {phone}",
    "verifyCode.codeLabel": "رمز التحقق",
    "verifyCode.codeRequired": "رمز التحقق مطلوب",
    "verifyCode.codeVerified": "تم التحقق من الرمز بنجاح!",
    "verifyCode.verifyError": "رمز التحقق غير صحيح",
    "verifyCode.verifyButton": "تحقق من الرمز",
    "verifyCode.resendCode": "إعادة إرسال الرمز",
    "verifyCode.codeResent": "تم إعادة إرسال رمز التحقق بنجاح!",
    "verifyCode.resendError": "فشل في إعادة إرسال رمز التحقق",
    "verifyCode.backToPhone": "العودة إلى رقم الهاتف",
    ...
    "resetPassword.confirmPlaceholder": "تأكيد كلمة المرور الجديدة",
    "resetPassword.fillAllFields": "يرجى ملء جميع الحقول",
    "resetPassword.passwordMismatch": "كلمات المرور غير متطابقة",
    "resetPassword.passwordTooShort":
      "يجب أن تكون كلمة المرور 6 أحرف على الأقل",
    "resetPassword.resetSuccess": "تم إعادة تعيين كلمة المرور بنجاح!",
    "resetPassword.resetError": "فشل في إعادة تعيين كلمة المرور",
    ...
    "landing.heroSubtitle":
      "منصة المقايضة الحديثة: بدّل ما لا تحتاجه، واحصل على ما تحب — مع إمكانية دفع أو استلام فرق نقدي.",
    ...
    "landing.featuresSubtitle":
      "اختبر أسهل وأأمن طريقة لتبادل الأشياء مع إمكانية دفع أو استلام فرق نقدي حسب الاتفاق.",
    "landing.feature1.title": "تبادل أي شيء",
    "landing.feature1.description":
      "تبادل الأشياء بدون بيع مباشر — ويمكنك دفع أو استلام فرق نقدي حسب رغبتك.",
    "landing.feature2.title": "مجتمع آمن",
    "landing.feature2.description":
      "انضم إلى مجتمع موثوق من التجار مع ملفات شخصية وتقييمات محققة.",
    "landing.feature3.title": "تبادل آمن",
    "landing.feature3.description":
      "معاملات محمية مع حل النزاعات المدمج والدعم.",
    "landing.feature4.title": "مطابقة فورية",
    "landing.feature4.description":
      "خوارزمية ذكية تربطك بالتجار الذين يريدون ما لديك.",
    ...
    "landing.services.direct.description":
      "تبادل الأشياء مباشرة بدون تدخل المال. مثالي للتبادلات متساوية القيمة.",
    "landing.services.money.title": "تبادل بفرق مالي",
    "landing.services.money.description":
      "أضف أو استلم مال لموازنة التبادل عندما تكون الأشياء بقيم مختلفة.",
    "landing.services.secure.title": "معاملات آمنة",
    "landing.services.secure.description":
      "جميع التبادلات محمية بنظام الضمان الآمن وحل النزاعات.",
    "landing.services.community.title": "تحقق المجتمع",
    "landing.services.community.description":
      "نظام تحقق المستخدمين يضمن التبادل الآمن مع أعضاء مجتمع موثوقين.",

    // Stats
    "landing.stats.traders": "تاجر نشط",
    "landing.stats.items": "غرض متبادل",
    ...
    "landing.testimonials.user1.text":
      "تبادل جعل الأمر سهلاً جداً لتبديل لابتوبي القديم بدراجة هوائية. خاصية الفرق المالي كانت مثالية!",
    "landing.testimonials.user2.name": "فاطمة حسن",
    "landing.testimonials.user2.text":
      "أحب مدى أمان وحماية المنصة. التبادل لم يكن بهذه السهولة من قبل.",
    "landing.testimonials.user3.name": "عمر محمود",
    "landing.testimonials.user3.text":
      "المجتمع رائع ودعم العملاء ممتاز. أنصح به بشدة!",
    ...
    "landing.faq.q1.answer":
      "عند تبادل أشياء بقيم مختلفة، يمكنك إضافة أو استلام مال لموازنة التبادل. هذا يجعل التبادل العادل ممكناً لأي أشياء.",
    "landing.faq.q2.question": "هل معلوماتي الشخصية آمنة؟",
    "landing.faq.q2.answer":
      "نعم، نستخدم تشفير متقدم وإجراءات أمنية لحماية جميع بيانات المستخدمين. خصوصيتك هي أولويتنا القصوى.",
    "landing.faq.q3.question": "ماذا لو كان لدي نزاع مع تاجر آخر؟",
    "landing.faq.q3.answer":
      "لدينا نظام شامل لحل النزاعات مع فريق دعم مخصص لمساعدة حل أي مشاكل بعدالة.",
    "landing.faq.q4.question": "هل هناك رسوم لاستخدام تبادل؟",
    "landing.faq.q4.answer":
      "التبادل الأساسي مجاني! نحن نتقاضى رسوم صغيرة فقط للميزات المتميزة ومعالجة الدفع الآمن.",
    ...
    "items.editItem": "تعديل الغرض",
    "items.createNewItem": "إنشاء غرض جديد",
    "items.titlePlaceholder": "ادخل عنوان الغرض",
    "items.description": "الوصف",
    "items.descriptionPlaceholder": "ادخل وصف الغرض",
    ...
    "exchange.status.rejected": "مرفوض",
    "exchange.status.pendingdelivery": "تمت الموافقة بإنتظار إكمال التبديل",
    "exchange.status.completed": "مكتمل",
    ...
    "exchange.success": "نجاح",
    "exchange.acceptsuccess": "تم قبول طلب التبادل بنجاح",
    "exchange.rejectSuccess": "تم رفض طلب التبادل بنجاح",
    "exchange.error": "خطأ",
    ...
    addressNamePlaceholder: "أدخل اسم العنوان",
    street: "عنوان الشارع",
    ...
    famousSign: "علامة مميزة",
    famousSignPlaceholder: "أدخل علامة مميزة أو معلم شهير",
    building: "مبنى",
    floor: "طابق",
    flat: "شقة",
    notes: "ملاحظات",
    ...
    "notifications.enabledDescription":
      "سوف تتلقى إشعارات فورية للتحديثات الهامة.",
    "notifications.failed": "فشل التفعيل",
    "notifications.failedDescription":
      "تعذر تفعيل الإشعارات. يرجى المحاولة مرة أخرى.",
    "notifications.title": "الإشعارات",
    "notifications.none": "لا توجد إشعارات",
    "notifications.bellAriaLabel": "الإشعارات",
    "exchange.phoneNumber": "رقم الجوال",
  },
};
