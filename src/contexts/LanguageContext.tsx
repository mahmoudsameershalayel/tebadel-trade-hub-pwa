...
const translations = {
  ...
  ar: {
    ...
    'items.loadError': 'فشل في تحميل العناصر',
    'items.deleteSuccess': 'تم حذف العنصر بنجاح',
    'items.subTitle' : "اكتشف الأغراص من حولك وقدم العروض عليها",
    "myItems.yourItems" : "عناصرك",
    "myItems.deleteConfirm" : "تأكيد حذف الغرض",
    "myItems.itemDetails" : "تفاصيل العنصر",
    ...
    'myItems.qrAlt': 'رمز الاستجابة السريعة للعنصر',
    // Trading & Money Difference
